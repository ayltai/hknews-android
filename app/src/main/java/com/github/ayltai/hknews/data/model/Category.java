...
public class Category extends RealmObject implements Comparable<Category>, Parcelable {
    public static final String REAL_TIME = "即時";
    ...
    @Nonnull
    @NonNull
    public static String getDisplayName(@Nonnull @NonNull @lombok.NonNull final String categoryName) {
        return categoryName.length() > 2 ? categoryName.substring(2) : categoryName;
    }
    ...
    @Override
    public boolean equals(@Nullable final Object category) {
