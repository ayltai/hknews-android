...
public final class CozyItemView extends ItemView {
    ...
    public CozyItemView(@Nonnull @NonNull @lombok.NonNull final Context context) {
        ...
        this.image.setImageLoaderCallback(new BaseImageLoaderCallback() {
            ...
            public void onFinish() {
                MediaUtils.configure(CozyItemView.this.image);
            }
        });
    ...
    public void setIsRead(final boolean isRead) {
        this.container.setAlpha(isRead ? CozyItemView.ALPHA : 1f);
        this.icon.setAlpha(isRead ? CozyItemView.ALPHA : 1f);
        this.title.setAlpha(isRead ? CozyItemView.ALPHA : 1f);
        this.description.setAlpha(isRead ? CozyItemView.ALPHA : 1f);
        this.source.setAlpha(isRead ? CozyItemView.ALPHA : 1f);
        this.publishDate.setAlpha(isRead ? CozyItemView.ALPHA : 1f);
        this.image.setAlpha(isRead ? CozyItemView.ALPHA : 1f);
    }
